...
mod tests {
    ...
    fn test_event() {
        ...
        components::set::<Building>(target.path(), Building {
            status: 3,
            building_type: building_types::FACTORY,
            planned_at: 1,
            finish_time: 1
        });
        ...
        let result = NoSoundInSpace::resolve(1, FixedTrait::new(1, false), crew_details);
